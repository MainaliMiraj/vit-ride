...
const RidePerks = () => {
  return (
    <div className="flex flex-col gap-4 mt-4 items-center font-extrabold text-lg">
      ...
      <div className="flex flex-row w-full gap-8 items-center justify-cente px-12">
        <div className="bg-slate-200 flex items-center flex-col p-4 gap-2">
          ...
          <Button buttonName="Discover More" bgColor="gray" textColor="black" />
        </div>
        ...
        <div className="bg-slate-200 flex items-center flex-col p-4 gap-2">
          ...
          <Button buttonName="Find out How" bgColor="gray" textColor="black" />
        </div>
        <div className="bg-slate-200 flex items-center flex-col p-4 gap-2">
          ...
          <Button buttonName="Learn More" bgColor="red" textColor="green" />
        </div>
      </div>
    </div>
  );
